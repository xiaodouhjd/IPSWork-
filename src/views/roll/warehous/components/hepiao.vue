...
<Table :data="tableData" :columns="tableColumns" :loading="loading" multiselect key="" :page="rollPutData.pageIndex" :limit="rollPutData.pageSize" :total="rollPutData.total" @changePage="changePage" @selectRow="selectRow"></Table>
</template>
</PageContainer>
</div>
</template>
...
changePage(val) {
let { limit, page } = val;
this.sendAllRollData.pageIndex = page;
this.sendAllRollData.pageSize = limit;
this.getAllRollData();
}
},
created() {
